...
const QVector2D PublicConstants::BallSize = QVector2D(15.0f, 15.0f);
...
const QVector2D PublicConstants::BonusBodySpeed = QVector2D(0, 1.5);
const float PublicConstants::sizePlatformMultiplier_dec = 0.5;
const float PublicConstants::sizePlatformMultiplier_inc = 2;
const float PublicConstants::speedBallMultiplyier_dec = 0.8;
const float PublicConstants::speedBallMultiplyier_inc = 1.25;
